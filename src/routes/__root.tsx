  ...
  head: () => ({
    meta: [
      ...
      { title: "Roddis Roofing | Roofing Specialists in Nottingham & Derbyshire" },
      {
        name: "description",
        content:
          "Family run roofing specialists covering Nottingham, Nottinghamshire & Derbyshire. Roof repairs, new roofs, lead work and free quotes.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Roddis Roofing" },
